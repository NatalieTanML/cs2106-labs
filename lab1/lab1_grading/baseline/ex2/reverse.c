/*
    Used for checking that reverse_list did not deallocate and
    reallocate memory.
*/
...
int main() {
    ...
    if (return_code != 0) {
        printf("Addresses of nodes have been modified. Implementation of reverse_list is incorrect.\n");
    }
    return return_code;
}
